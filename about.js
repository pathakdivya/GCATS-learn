...
class AboutPage {
  ...
  constructor() {
    ...
    this.continueBtn = document.getElementById("about-continue-btn")

    this.choiceButtons.forEach(btn => {
      btn.addEventListener("click", () => this.selectStick(btn.dataset.stick))
    })
  ...
  updateStickVisual(dot, circle, x, y) {
    const maxOffset = 14
