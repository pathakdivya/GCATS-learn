...
interface ChecklistStep {
    ...
    label: string;
    dwellMs: number;
    check: (stick: StickInput, buttons: readonly GamepadButton[]) => boolean;
}

class ChecklistController {
    private stick: Stick | null;

    private currentText: HTMLElement;
    private listEl: HTMLElement;
    private stickDot: HTMLElement;
    private stickLine: HTMLElement | null;
    private targetEl: HTMLElement;
    private completeScreen: HTMLElement;
    private noStickNotice: HTMLElement;
    private checklistLayout: HTMLElement;

    private visualStickDot: HTMLElement;
    private visualStickCircle: HTMLElement;
    private diagramButtonEls: Record<string, HTMLElement>;
    ...
    private readonly TARGET_TRIALS_REQUIRED = 10;
    private targetTrialsCompleted = 0;
    ...
    constructor() {
        ...
        this.visualStickDot = document.getElementById('visual-stick-left')!;
        this.visualStickCircle = document.getElementById('visual-stick-left-circle')!;
    ...
    private buildSteps(): ChecklistStep[] {
        ...
        return [
            ...
            {
                id: 'confirm',
                label: 'Press the confirmation button (Cross / A)',
                dwellMs: 0,
    ...
    private updateCurrentStepUI(): void {
    ...
    private lastButtons: readonly GamepadButton[] = [];

    private updateDiagramStick(stick: StickInput): void {
        const maxOffset = 14;
    ...
    private updateChecklistStick(stick: StickInput): void {
        const maxOffset = 32;
    ...
    private evaluateCurrentStep(stick: StickInput): void {
        const step = this.steps[this.currentStepIndex];
        if (!step) return;
